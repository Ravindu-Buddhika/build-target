      ...
      onCreate: (db, version) async {
        ...
        await db.execute('''
          CREATE TABLE Goals (
            ...
            user_id INTEGER,
            goal_name TEXT,
            full_plan_content TEXT, -- JSON structure එක String එකක් ලෙස
            status TEXT,
        ...
        await db.execute('''
          CREATE TABLE Trophies (
            ...
            first_spark INTEGER DEFAULT 0,
            triple_threat INTEGER DEFAULT 0,
            week_warrior INTEGER DEFAULT 0,
            fortnight_force INTEGER DEFAULT 0,
            ultimate_finisher INTEGER DEFAULT 0,
            FOREIGN KEY (user_id) REFERENCES Users (id) ON DELETE CASCADE
          )
        ''');
